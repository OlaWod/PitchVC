...
def process_batch(batch, args, h, spk2id, f0_stats):
    # global device
...
if __name__ == "__main__":
    ...
    parser.add_argument("--n_processes", type=int, default=6, help="number of multiprocessing processes")
    ...
    with ProcessPoolExecutor(max_workers=n_processes) as executor:
        ...
        for i in range(n_processes):
            ...
            tasks.append(executor.submit(process_batch, batch, args, h, spk2id, f0_stats))
